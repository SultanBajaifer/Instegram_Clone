...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="flex justify-center">
                <h1 style="font-family: Norican; font-size: 35px" class="text-2xl md:text-5xl">Instagram Sultan</h1>
            </div>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'ms-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH D:\MyProjects\instagram\resources\views/auth/login.blade.php ENDPATH**/ ?>