...
? 'block w-full ps-3 pe-4 py-2 border-l-4 border-indigo-400 text-left text-base font-medium text-indigo-700 bg-indigo-50
focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition duration-150
ease-in-out'
: 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-left text-base font-medium text-gray-600
...
</a><?php /**PATH D:\MyProjects\instagram\resources\views/components/responsive-nav-link.blade.php ENDPATH**/ ?>